...
title: Rules
---
### Getting Started Honor Code
This is a fun competition aimed at helping to build new ways to analays AIRR-seq data and to create novel ways to classify sequences and repertoires. 

### One account per participant
You cannot sign up to the competition from multiple accounts and therefore you cannot submit from multiple accounts.

### code sharing outside teams
Privately sharing code data outside of teams is **permitted and welcome**. It's okay to share code to all participants on the forums.
...
### Submission Limits
You may submit a maximum of 2 entries per week.
...
Competition End Date: March 10, 2023

### COMPETITION-SPECIFIC TERMS

COMPETITION TITLE: AIRR-seq ...
...
This competition permits the use of automated machine learning tool(s) (“AMLT”) in the creation of Submissions.

Individual participants and Teams may also use an AMLT (i.e. Google AutoML, H2O Driverless AI, etc.) to create a Submission, provided that the participant ensures that they have an appropriate license to the AMLT and are able to comply with the Rules.
...
The Competition Data is also subject to the following terms and conditions of the WikiArt and Flickr licenses under which it was originally licensed: WikiArt License & Flickr License, as specified by the CycleGAN "monet2photo" dataset's published sources: CycleGAN. To the extent that the terms and conditions located at the URL conflict with or are inconsistent with these Rules, these Rules will govern your use of the Competition Data.
...
C. External Data. You may use data other than the Competition Data (“External Data”) to develop and test your models and Submissions. However, you will ensure the External Data is available to use by all participants of the competition for purposes of the competition at no cost to the other participants.
...
You hereby release Competition Entities from any liability associated with: (a) any malfunction or other problem with the Competition Website; or (b) any error in the collection, processing, or retention of any Submission.
